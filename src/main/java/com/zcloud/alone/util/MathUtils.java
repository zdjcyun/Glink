...
public class MathUtils {
    ...
    /**
     * 保留newScale位有效数字,并且四舍五入
     */
    public static double doubleRoundOff(String s, int newScale) {
        BigDecimal bigDecimal1 = new BigDecimal(s).setScale(newScale, BigDecimal.ROUND_HALF_UP);
